...
const companyInfoFilePath = path_1.default.join(dataDirectory, 'companyInfo.json');
...
const loadData = () => {
    try {
        ...
        if (fs_1.default.existsSync(companyInfoFilePath)) {
            const companyInfoData = fs_1.default.readFileSync(companyInfoFilePath, 'utf-8');
...
const saveData = () => {
    try {
        ...
        fs_1.default.writeFileSync(companyInfoFilePath, JSON.stringify(companyInfo, null, 2));
    }
    catch (error) {
...
app.post('/api/customers', (req, res) => {
    const newCustomer = Object.assign(Object.assign({}, req.body), { rounding: req.body.rounding || '四捨五入' });
...
app.put('/api/customers/:id', (req, res) => {
    ...
    if (customerIndex > -1) {
        customers[customerIndex] = Object.assign(Object.assign(Object.assign({}, customers[customerIndex]), updatedCustomerData), { rounding: updatedCustomerData.rounding || customers[customerIndex].rounding });
        saveData();
...
app.post('/api/products', (req, res) => {
    const newProduct = Object.assign(Object.assign({}, req.body), { taxCategory: req.body.taxCategory || '10' });
...
app.put('/api/products/:id', (req, res) => {
    ...
    if (productIndex > -1) {
        products[productIndex] = Object.assign(Object.assign(Object.assign({}, products[productIndex]), updatedProductData), { taxCategory: updatedProductData.taxCategory || products[productIndex].taxCategory });
        saveData();
...
app.put('/api/deliveries/:id', (req, res) => {
    ...
    if (deliveryIndex > -1) {
        try {
            ...
            deliveries[deliveryIndex] = Object.assign(Object.assign(Object.assign({}, currentDelivery), updatedDeliveryData), { items: updatedItems, customerId: updatedCustomerId, taxCategory: updatedDeliveryData.taxCategory || currentDelivery.taxCategory });
            saveData();
...
app.get('/api/deliveries/:id/pdf', (req, res) => {
    ...
    try {
        const doc = new pdfkit_1.default({ size: 'A4', margin: 0 }); // 余白を0に設定
        ...
        doc.font(fontPath);
        const drawDeliveryNote = (isCopy, startY) => {
            const marginX = 30;
            ...
            // Company Info
            doc.font(path_1.default.join(__dirname, 'src/fonts/NotoSansJP-Bold.ttf')).fontSize(10).text(companyInfo.name, rightBlockX, currentYRight, { width: rightBlockWidth, align: 'right' });
            doc.font(path_1.default.join(__dirname, 'src/fonts/NotoSansJP-Regular.ttf')); // Reset to regular font
            currentYRight += 12;
            ...
            delivery.items.forEach(item => {
                ...
                doc.text(((_a = item.quantity) === null || _a === void 0 ? void 0 : _a.toLocaleString()) || '', col2X, currentY + 3, { width: col2Width, align: 'right' });
                doc.text(item.unit || '', col3X, currentY + 3, { width: col3Width, align: 'center' });
                doc.text(((_b = item.unitPrice) === null || _b === void 0 ? void 0 : _b.toLocaleString()) || '', col4X, currentY + 3, { width: col4Width, align: 'right' });
...
app.post('/api/company-info', (req, res) => {
    companyInfo = Object.assign(Object.assign({}, companyInfo), req.body);
    saveData();
